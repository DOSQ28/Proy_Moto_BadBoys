...
<html lang="en" data-bs-theme="auto">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="Login" method="post">
            <img class="mb-4" src="https://elcomercio.pe/resizer/bSzBxAvVozDP3UkVeBX8oXDsKFs=/580x330/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/MFI2G4AKPREBFFWI4KSFKCQAHQ.png" alt="" width="72" height="57">
